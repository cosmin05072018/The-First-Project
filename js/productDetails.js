...
const productPhoto = document.querySelector(".photo-container");
const productInfo = document.querySelector(".info-container");

const params = new URLSearchParams(window.location.search);
const productId = params.get("id");
const previewedProduct = allProducts.filter(
  (product) => product.imgSourceName === productId
);
...
function renderProductDetails(data) {
  ...
  switch (data.collection) {
    case "accessories":
      photoURL = "../images/accessories";
      break;
    case "Kids":
      photoURL = "../images/Kids";
      break;
    case "women":
      photoURL = "../images/women";
      break;
    case "men":
      photoURL = "../images/men";
      break;
  ...
  productPhoto.style.width = "600px";
  productPhoto.style.height = "600px";
  productPhoto.style.backgroundImage = `url("${photoURL}/${productId}.png")`;
  productPhoto.style.backgroundRepeat = "no-repeat";
...
renderProductDetails(previewedProduct[0]);
